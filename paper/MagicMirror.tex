...
This project was inspired by the already existing work of Michael Teeuw:Xonay Labs Retrieved from \href{michaelteeuw.nl}{michaelteeuw.nl}. The hardware implementation we followed is straighforward follows the work of Michael Teeuw:Xonay Labs Step by step method Retrived from \href{http://michaelteeuw.nl/post/80391333672/magic-mirror-part-i-the-idea-the-mirror}{http://michaelteeuw.nl/post/80391333672/magic-mirror-part-i-the-idea-the-mirror}. As we went along with the implementation we came across an idea of including a PIR sensor. By employing PIR we can detect the human presence , thereby automating the screen to turn on and off when someone stands infront of it. This not only provides a futuristic feature but also conserves energy . 
